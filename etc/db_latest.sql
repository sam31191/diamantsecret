...
-- Dumping database structure for db_diamantsecret
CREATE DATABASE IF NOT EXISTS `db_diamantsecret` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `db_diamantsecret`;

-- Dumping structure for table db_diamantsecret.accounts
...
-- Dumping data for table db_diamantsecret.accounts: ~3 rows (approximately)
...
INSERT INTO `accounts` (`id`, `site_id`, `email`, `username`, `password`, `first_name`, `last_name`, `mobileno`, `address`, `favorites`, `type`, `cart`, `activated`, `verification_hash`, `recover_hash`) VALUES
	(1, 1, 'contact@diamantsecret.com', 'Admin', 'admin123', 'Admin', '', '032985866', 'Hoveniersstraat 30 Suite: 924, 2018 Antwerpen - Belgium', ',eXHRwDlpEe', 1, 'E07lak14Th|0|1,', 1, '', ''),
...
-- Dumping structure for table db_diamantsecret.bracelets
...
-- Dumping data for table db_diamantsecret.bracelets: ~0 rows (approximately)
/*!40000 ALTER TABLE `bracelets` DISABLE KEYS */;
/*!40000 ALTER TABLE `bracelets` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.categories
...
-- Dumping data for table db_diamantsecret.categories: ~5 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.clarity
...
-- Dumping data for table db_diamantsecret.clarity: 10 rows
/*!40000 ALTER TABLE `clarity` DISABLE KEYS */;
INSERT INTO `clarity` (`id`, `clarity`) VALUES
	...
	(9, 'SI3'),
	(10, 'I1');
/*!40000 ALTER TABLE `clarity` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.color
...
-- Dumping data for table db_diamantsecret.color: 4 rows
...
-- Dumping structure for table db_diamantsecret.company_id
...
-- Dumping data for table db_diamantsecret.company_id: ~0 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.country_vat
...
-- Dumping data for table db_diamantsecret.country_vat: ~28 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.diamonds
...
-- Dumping data for table db_diamantsecret.diamonds: ~0 rows (approximately)
/*!40000 ALTER TABLE `diamonds` DISABLE KEYS */;
/*!40000 ALTER TABLE `diamonds` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.diamond_color
...
-- Dumping data for table db_diamantsecret.diamond_color: 8 rows
...
-- Dumping structure for table db_diamantsecret.diamond_shape
...
-- Dumping data for table db_diamantsecret.diamond_shape: ~17 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.earrings
...
-- Dumping data for table db_diamantsecret.earrings: ~0 rows (approximately)
/*!40000 ALTER TABLE `earrings` DISABLE KEYS */;
/*!40000 ALTER TABLE `earrings` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.gold_quality
...
-- Dumping data for table db_diamantsecret.gold_quality: 4 rows
/*!40000 ALTER TABLE `gold_quality` DISABLE KEYS */;
INSERT INTO `gold_quality` (`id`, `gold_quality`) VALUES
	(1, '22k'),
	(2, '18k'),
	(3, '14k'),
	(4, '9k');
/*!40000 ALTER TABLE `gold_quality` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.items
...
-- Dumping data for table db_diamantsecret.items: ~0 rows (approximately)
/*!40000 ALTER TABLE `items` DISABLE KEYS */;
/*!40000 ALTER TABLE `items` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.materials
...
-- Dumping data for table db_diamantsecret.materials: ~8 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.moderator_login
...
-- Dumping data for table db_diamantsecret.moderator_login: ~20 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.necklaces
...
-- Dumping data for table db_diamantsecret.necklaces: ~0 rows (approximately)
/*!40000 ALTER TABLE `necklaces` DISABLE KEYS */;
/*!40000 ALTER TABLE `necklaces` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.pendants
...
-- Dumping data for table db_diamantsecret.pendants: ~0 rows (approximately)
/*!40000 ALTER TABLE `pendants` DISABLE KEYS */;
/*!40000 ALTER TABLE `pendants` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.rings
...
-- Dumping data for table db_diamantsecret.rings: ~0 rows (approximately)
/*!40000 ALTER TABLE `rings` DISABLE KEYS */;
/*!40000 ALTER TABLE `rings` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.ring_subcategory
...
-- Dumping data for table db_diamantsecret.ring_subcategory: ~38 rows (approximately)
...
-- Dumping structure for table db_diamantsecret.subscribers
...
-- Dumping data for table db_diamantsecret.subscribers: ~0 rows (approximately)
/*!40000 ALTER TABLE `subscribers` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribers` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.tb_websites
...
-- Dumping data for table db_diamantsecret.tb_websites: 8 rows
...
-- Dumping structure for table db_diamantsecret.tmp_table
...
-- Dumping data for table db_diamantsecret.tmp_table: ~0 rows (approximately)
/*!40000 ALTER TABLE `tmp_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `tmp_table` ENABLE KEYS */;

-- Dumping structure for table db_diamantsecret.version
...
-- Dumping data for table db_diamantsecret.version: ~1 rows (approximately)
/*!40000 ALTER TABLE `version` DISABLE KEYS */;
INSERT INTO `version` (`id`, `sql_version`) VALUES
	(1, 'diamantsecretdb_1_4_4');
