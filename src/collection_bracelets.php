                    ...
                    <div itemprop="breadcrumb" class="container">
                        <div class="row">
                            <div class="col-md-24">
                                ...
                                <span>/</span>
                                <span class="page-title"><a href="<?php echo $__MAINDOMAIN__.''.$lang.'/'?>bracelets" title="<?php echo __("View All"); ?>"><?php echo __("Bracelets"); ?></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row"> 
                            <div id="collection-content">
                                <div id="page-header">
                                    <h1 id="page-title"><?php echo __("Bracelets"); ?></h1>
                                </div>
                                        ...
                                        <div class="group_sidebar">
                                            <div class="sb-wrapper">
                                                ...
                                                <div class="filter-tag-group">
                                                    ...
                                                    <h6 class="sb-title"><?php echo __("Filter"); ?> <a href="<?php echo $__MAINDOMAIN__.''.$lang.'/'?>bracelets" style="font-size:12px"><?php echo __("clear selection"); ?></a><button class="btn" form="filterForm" type="submit" style="float:right;"><?php echo __("Apply"); ?></button></h6>
                                                    <!-- tags groupd 1 -->
                                                        ...
                                                        <ul>
                                                            ...
                                                            if ( $fetchAvailableMaterials->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableMaterials->fetchAll() as $qualityOption ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM bracelets WHERE gold_quality = :gold_quality");
                                        ...
                                        <div id="sandBox-wrapper" class="group-product-item row collection-full">
                                            <ul id="sandBox" class="list-unstyled">
                                                ...
                                                <?php
                                                    ...
                                                    $count = $pdo->prepare("SELECT COUNT(*) AS totalRows FROM `items` INNER JOIN `bracelets` ON items.unique_key = bracelets.unique_key WHERE `category` = 5 AND site_0 = 1 AND disabled = 0" . $filterX);
                                                    $count->execute();
                                                    ...
                                                    $getAll = $pdo->prepare("SELECT * FROM `items` INNER JOIN `bracelets` ON items.unique_key = bracelets.unique_key WHERE `category` = 5 AND site_0 = 1 AND disabled = 0 " . $filterX . $filter );
