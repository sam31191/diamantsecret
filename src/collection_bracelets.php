                    ...
                    <div itemprop="breadcrumb" class="container">
                        <div class="row">
                            <div class="col-md-24">
                                ...
                                <span>/</span>
                                <span class="page-title"><a href="./collection_bracelets.php" title="<?php echo __("View All"); ?>"><?php echo __("Bracelets"); ?></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="group_sidebar">
                                            <div class="sb-wrapper">
                                                ...
                                                <div class="filter-tag-group">
                                                    ...
                                                    <h6 class="sb-title"><?php echo __("Filter"); ?> <a href="./collection_bracelets.php" style="font-size:12px"><?php echo __("clear selection"); ?></a><button class="btn" form="filterForm" type="submit" style="float:right;"><?php echo __("Apply"); ?></button></h6>
                                                    <!-- tags groupd 1 -->
