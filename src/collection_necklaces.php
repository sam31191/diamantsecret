...
<head>
  ...
  <title><?php echo __("Fine Diamond Necklaces").'-'.__('Best Gemstone Necklace').'-'.__('Chain Necklace').'-'.__('Pearl Necklace'); ?></title>
...
<body itemscope="" itemtype="http://schema.org/WebPage" class="templateCollection notouch">
    <?php
     $makeInLang = 'en';
     $opposite_category = "necklaces";
     $makeOppositeSubcategory = '';
     if(isset($_GET['lang']) && $_GET['lang']=='en'){ 
        $makeInLang = 'fr';
        $opposite_category = "colliers";
     }
                    ...
                    <div class="container">
                        <div class="row"> 
                            <div id="collection-content">
                                <div id="page-header">
                                    <h1 id="page-title"><?php echo __("Necklace"); ?></h1>
                                </div>
                                ...
                                <?php
                                    ...
                                    if ( isset($_GET['_sc']) && !empty($_GET['_sc']) ) {
                                      ...
                                      $data=$pdo->prepare("select id from ring_subcategory WHERE category='".ucwords(strtolower(str_replace("-"," ", $ringTag)))." Necklace' and category_id = 4");
                                      $data->execute();
                                        ...
                                        <div class="group_sidebar">
                                            <div class="sb-wrapper">
                                                ...
                                                <div class="filter-tag-group">
                                                    ...
                                                    <h6 class="sb-title"><?php echo __("Filter"); ?> <a href="<?php echo $__MAINDOMAIN__.$lang.'/'.__('necklaces')?>" style="font-size:12px"><?php echo __("clear selection"); ?></a><button class="btn" form="filterForm" type="submit" style="float:right;"><?php echo __("Apply"); ?></button></h6>
                                                    <!-- tags groupd 1 -->
                                                        ...
                                                        <select form="filterForm" name="clarity" id="clarityFilter">
                                                            ...
                                                            if ( $fetchAvailableClarity->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableClarity->fetchAll() as $clarity ) {
                                                                    $checkIfClarityExists = $pdo->prepare("SELECT COUNT(id) AS clarityCount FROM necklaces WHERE clarity = :clarity");
                                                        ...
                                                        <ul>
                                                            ...
                                                            if ( $fetchAvailableMaterials->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableMaterials->fetchAll() as $materialOption ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM necklaces WHERE material = :material");
                                                        ...
                                                        <ul>
                                                            ...
                                                            if ( $fetchAvailableMaterials->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableMaterials->fetchAll() as $qualityOption ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM necklaces WHERE gold_quality = :gold_quality");
                                                        ...
                                                        <select form="filterForm" name="_sc">
                                                            ...
                                                            if ( $query->rowCount() > 0 ) {
                                                                ...
                                                                foreach ( $query as $option ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM necklaces WHERE ring_subcategory = :ring_subcategory");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 product-information">
                            ...
                            <div id="quick-shop-container">
                                ...
                                <form method="post" enctype="multipart/form-data" action="<?php echo $__MAINDOMAIN__.$lang.'/'.__('necklaces') ?>">
