										...
										<div class="group_sidebar">
											<div class="sb-wrapper">
												...
												<div class="filter-tag-group">
													...
													<h6 class="sb-title">Filter <a href="./collection_necklaces.php" style="font-size:12px">clear</a><button class="btn" form="filterForm" type="submit" style="float:right;">Apply</button></h6>
													<!-- tags groupd 1 -->
										...
										<div id="sandBox-wrapper" class="group-product-item row collection-full">
											<ul id="sandBox" class="list-unstyled">
												...
												<?php
													...
													$getAll = $pdo->prepare("SELECT * FROM `items` WHERE `category` = 4 " . $filter);
													$getAll->execute();
