							...
							<div id="collection-content">
								...
								if ( isset($_GET['material']) ) {
									...
									if ( !empty($_GET['ring_category']) ) {
										$ringTag = '<label class="label label-info">'. $_GET['ring_category'] .'</label>';
									} else {
										$ringTag = "";
									}
									echo '
													...
													<div class="">
														<div class="home_deal_fp">
															...
															<div class="home_deal_fp_wrapper sb-content">
																<div id="home_deal_fp">
																<?php
																$getItem = $pdo->prepare("SELECT * FROM `items` WHERE `featured` = 1 AND `category` = 1 ORDER BY `date_added` DESC LIMIT 5");
																$getItem->execute();
