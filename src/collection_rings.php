                    ...
                    <div itemprop="breadcrumb" class="container">
                        <div class="row">
                            <div class="col-md-24">
                                ...
                                <span>/</span>
                                <span class="page-title"><a href="<?php echo $__MAINDOMAIN__.''.$lang.'/'?>rings" title="<?php echo __("View All"); ?>"><?php echo __("Rings"); ?></a></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row"> 
                            <div id="collection-content">
                                <div id="page-header">
                                    <h1 id="page-title"><?php echo __("Rings"); ?></h1>
                                </div>
                                        ...
                                        <div class="group_sidebar">
                                            <div class="sb-wrapper">
                                                ...
                                                <div class="filter-tag-group">
                                                    ...
                                                    <h6 class="sb-title"><?php echo __("Filter"); ?> <a href="<?php echo $__MAINDOMAIN__.''.$lang.'/'?>rings" style="font-size:12px"><?php echo __("clear selection"); ?></a><button class="btn" form="filterForm" type="submit" style="float:right;"><?php echo __("Apply"); ?></button></h6>
                                                    <!-- tags groupd 1 -->
                                                        ...
                                                        <select form="filterForm" name="clarity" id="clarityFilter">
                                                            ...
                                                            if ( $fetchAvailableClarity->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableClarity->fetchAll() as $clarity ) {
                                                                    $checkIfClarityExists = $pdo->prepare("SELECT COUNT(id) AS clarityCount FROM rings WHERE clarity = :clarity");
                                                        ...
                                                        <ul>
                                                            ...
                                                            if ( $fetchAvailableMaterials->rowCount() > 0 ) {
                                                                foreach ( $fetchAvailableMaterials->fetchAll() as $materialOption ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM rings WHERE material = :material");
                                                        ...
                                                        <select form="filterForm" name="_sc">
                                                            ...
                                                            if ( $query->rowCount() > 0 ) {
                                                                ...
                                                                foreach ( $query as $option ) {
                                                                    $checkIfOptionExists = $pdo->prepare("SELECT COUNT(id) AS optionCount FROM rings WHERE ring_subcategory = :ring_subcategory");
                                                    ...
                                                    <div class="tag-group" id="price-tag-group">
                                                        ...
                                                        <h6 class="sb-title"><?php echo __("Filter"); ?> <a href="<?php echo $__MAINDOMAIN__;?>rings" style="font-size:12px"><?php echo __("clear selection"); ?></a><button class="btn" form="filterForm" type="submit" style="float:right;"><?php echo __("Apply"); ?></button></h6>
                                                    </div>
                                                    ...
                                                    <div class="">
                                                        <div class="home_deal_fp">
                                                            ...
                                                            <div class="home_deal_fp_wrapper sb-content">
                                                                <div id="home_deal_fp">
                                                                <?php
                                                                $getItem = $pdo->prepare("SELECT * FROM `items` WHERE `featured` = 1 AND `category` = 1 AND site_0 = 1 AND disabled = 0 ORDER BY `date_added` DESC LIMIT 5");
                                                                $getItem->execute();
                                        ...
                                        <div id="sandBox-wrapper" class="group-product-item row collection-full">
                                            <ul id="sandBox" class="list-unstyled">
                                                ...
                                                <?php
                                                    ...
                                                    $count = $pdo->prepare("SELECT COUNT(*) AS totalRows FROM `items` INNER JOIN `rings` ON items.unique_key = rings.unique_key WHERE `category` = 1 AND site_0 = 1 AND disabled = 0" . $filterX);
                                                    $count->execute();
                                                    ...
                                                    $getAll = $pdo->prepare("SELECT * FROM `items` INNER JOIN `rings` ON items.unique_key = rings.unique_key WHERE `category` = 1 AND site_0 = 1 AND disabled = 0 " . $filterX . $filter );
