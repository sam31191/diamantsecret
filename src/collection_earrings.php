					...
					<div itemprop="breadcrumb" class="container">
						<div class="row">
							<div class="col-md-24">
								...
								<span>/</span>
								<span class="page-title"><a href="./collection_earrings.php" title="View All">Earrings</a></span>
							</div>
						</div>
					</div>
				</div>
											...
											<ul id="sandBox" class="list-unstyled">
												...
												<?php
													...
													if ( !empty($priceTag) ) {
														switch($priceTag) {
															case 1: {
																$filterX .= " AND `item_value` > 0 AND `item_value` <= 100.00 ";
																break;
															} case 2: {
																$filterX .= " AND `item_value` > 100 AND `item_value` <= 299.99 ";
																break;
															} case 3: {
																$filterX .= " AND `item_value` > 300 AND `item_value` <= 599.99 ";
																break;
															} case 4: {
																$filterX .= " AND `item_value` > 600 AND `item_value` <= 999.99 ";
																break;
															} case 5: {
																$filterX .= " AND `item_value` > 1000 ";
																break;
															} default: {
																break;
															}
