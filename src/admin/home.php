      ...
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Sliders <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pages/featured.php">Featured</a></li>
                      <li><a href="pages/pendants.php">Pendants</a></li>
        ...
        <div class="right_col" role="main">
        	<?php 
				echo var_dump($_GET);
				if ( isset($_GET['show']) ) {
					$url = 'pages/'. $_GET['show'] .'.php';
					if (file_exists($url)) {
						include("pages/". $_GET['show'].".php");
					} else {
						include("../url/page_404.php");
					}
				}
			?>
        </div>
