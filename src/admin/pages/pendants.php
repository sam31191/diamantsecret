    ...
    <div class="container body">
      <div class="main_container" style="background: #607d8b;">
        ...
        <h3><?php
			...
			$count = $pdo->prepare("SELECT COUNT(*) AS totalRows FROM `items` WHERE `category` = 3");
			$count->execute();
    		...
    		echo '<h3><small><span id="total_items">' . $totalRows . '</span> Items Found</small>
		                ...
		                <a href="javascript:void(0);" class="btn btn-danger" onclick="removeAll(this)" name="pendants">Delete All</a>
		            </form>
		        </h3>';
        	?></h3>
