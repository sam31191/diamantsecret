      ...
      <div class="main_container" style="background: #607d8b;">
        ...
        <h3><?php
        	...
        	<table class="table table-hover table-custom table-custom-items" >
                ...
                <tbody>
                	<?php
		        	$query = $pdo->prepare("SELECT * FROM `items` INNER JOIN `pendants` ON items.unique_key = pendants.unique_key WHERE `category` = 3 ORDER BY ". $filter . " " . $currentOrder . " LIMIT ". $offset .", ". $perPage ." ");
