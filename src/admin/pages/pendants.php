  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container" style="background: #607d8b;">
        ...
        <h3>Pendants <button class="btn btn-custom" data-toggle="modal" data-target="#promptAddItem">Add</button><?php
        	...
        	<table class="table table-hover table-custom" style="display:block; overflow-y: hidden; overflow-x: scroll; white-space:nowrap; min-height: 80vh;" >
                ...
                <tbody>
                	<?php
		        	$query = $pdo->prepare("SELECT * FROM `items` WHERE `category` = 3 ORDER BY ". $filter . " " . $currentOrder . " LIMIT ". $offset .", ". $perPage ." ");
