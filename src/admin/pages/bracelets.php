      ...
      <div class="main_container" style="background: #607d8b;">
        ...
        <h3><?php
        	...
        	<table class="table table-hover table-custom table-custom-items">
                ...
                <tbody>
                	<?php
		        	$query = $pdo->prepare("SELECT * FROM `items` INNER JOIN `bracelets` ON items.unique_key = bracelets.unique_key WHERE `category` = 5 ORDER BY ". $filter . " " . $currentOrder . " LIMIT ". $offset .", ". $perPage ." ");
		        ...
		        <div class="container">
		            <div class="col-sm-12">
						<tbody>
							...
							<tr>
								<td> <span class="table-item-label">Company</span></td>
								<td>
									<div class="table-item">
